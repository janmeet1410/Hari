...
export default class Banner extends React.Component<IBannerProps, IBannerState> {
      ...
      <div id="Home">
        <section className="hero">
          ...
          <div className="infoflex">
            <div style={{ display: "none" }} className="tagline">
              ✨ Procurement AI Lab
            </div>
        ...
        <div style={{ backgroundColor: "#eb1700" }}>
          <div className="Pagecontainer">
            <section id="products" className="products-section">
              ...
              <p style={{ color: "#ffffff" }} className="subtitle">
                {this.props.aiproductdescription}
              </p>
              <div className="product-grid">
                {this.state.aiProducts.length > 0 &&
                  this.state.aiProducts.map((ele, ind) => {
                    const bgColor = backgroundColors[ind % backgroundColors.length];
                    return (
                      <div className="product-card">
                        <div className="icon">⚡</div>
                        <span className="status popular" style={{ background: bgColor }}>
                          {ele.Category}
                        </span>
                        <h3>{ele.Title}</h3>
                        ...
                        <div className="buttons">
                          <a href={ele.LearnMoreButtonLink}>
                            <button className="btn btn-primary" style={{ backgroundColor: "#eb1700" }}>
                              Learn More
                            </button>
                          </a>
                          <a href={ele.ViewDemoButtonLink}>
              ...
              <a className="abutton" style={{ color: "#ffffff", borderColor: "#ffffff" }} href="https://jnj.sharepoint.com/teams/ProcurementDigitalSolutions/SitePages/Products.aspx">
                View All Products
              </a>
            </section>
          </div>
            ...
            <section id="Usecases" className="success-section">
              ...
              <div className="case-grid">
                {this.state.aiInsights.length > 0 &&
                  this.state.aiInsights.map((el, ind) => {
                    const bgColor = backgroundColors1[ind % backgroundColors1.length];
                    return (
                      <div className="case-card">
                        <div className="case-header blue">
                          <div className="category" style={{ background: bgColor, width: "max-content" }}>
                            {el.Department}
                          </div>
                          {/* <div className="icon">⚡</div> */}
              ...
              <a className="abutton" href="https://jnj.sharepoint.com/teams/ProcurementDigitalSolutions/SitePages/Insight%20Usecases.aspx">
                View All Insight Usecases
              </a>
            </section>
          </div>
        </div>
        ...
        <section id="tech" className="tech-section" style={{ backgroundColor: "rgb(235, 23, 0)" }}>
          ...
          <p style={{ color: "#ffffff" }} className="subtitle">
            {this.props.aistackdesription}
          </p>

          <div className="tech-grid">
            {this.state.aiTechstacks.length > 0 &&
              this.state.aiTechstacks.map((element, ind) => {
                return (
  ...
  private getAIProducts = async () => {
    await sp.web.lists
      .getByTitle("AI Products")
      .items.select("ID,Title,Description,KeyFeatures,Category,Department,LearnMoreButtonLink,ViewDemoButtonLink,ProductOrder")
      .top(4999)
      .orderBy("ProductOrder", true)
      .top(4)
      .get()
      .then((data) => {
        let ProductArr = [];
  ...
  private getAITechStacks = async () => {
    await sp.web.lists
      .getByTitle("AI Tech Stack")
      .items.select("ID,Title,Description,Image")
